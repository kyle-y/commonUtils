...
public class DateUtils {
     ...
     * 获得当前日期的字符串格式：两种方法
     */
    public static String getCurDateStr1(String format) {
        Calendar c = Calendar.getInstance();
        return calendar2Str(c, format);
    }

    public static String getCurDateStr2() {// yyyy-MM-dd HH:mm:ss
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
     ...
     * @return
     */
    public static boolean nowIsBetweenTime(String begintime, String endtime) {
